# Retrieves metadata and specific columns from a CSV file in an input directory, rearranges and renames those columns, and then saves the updated data with the metadata to a new CSV file in an output directory.
import csv
import os
import sys
