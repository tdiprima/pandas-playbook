# Collects metadata and data from all .csv files in an input directory, storing each file's contents
# into a JSON object, and then writes these objects into new .json files in an output directory.
